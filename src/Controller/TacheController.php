...
class TacheController extends AbstractController
{
    ...
    #[Route('/taches/add', name: 'app_tache_add')]
    ...
    #[Route('/taches/update/{id}', name: 'app_tache_update')]
    public function update(ManagerRegistry $doctrine, Request $request, Tache $tache): Response
    {
        $form = $this->createForm(TacheType::class, $tache);
        $form->handleRequest($request);
        if ($form->isSubmitted() && $form->isValid()) {
